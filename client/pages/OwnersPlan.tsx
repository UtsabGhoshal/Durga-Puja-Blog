...
// Mobile-safe content component
const LocationContent = ({ location, locationIndex, dayColor, isMobile }: any) => (
  <div className="mobile-card bg-white rounded-lg sm:rounded-xl shadow-md border border-festival-orange/20 hover:shadow-lg transition-all duration-300">
    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4 mb-3 sm:mb-4">
      <div className="flex items-start gap-3 min-w-0 flex-1">
        <div
          className={`w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gradient-to-r ${dayColor} rounded-full flex items-center justify-center text-white font-bold shadow-lg flex-shrink-0`}
        >
    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3">
        {location.pandals.map((pandal: any, pandalIndex: number) => (
          <div
                    ...
                    <div className="overflow-hidden">
                      <CardContent className="mobile-card sm:p-6 lg:p-8 bg-gradient-to-br from-gray-50/80 to-festival-orange/5 overflow-x-hidden">
                        <div className="mobile-stack sm:space-y-6 lg:space-y-8">
                          ...
                          {day.choices && (
                            <div className="mobile-card bg-gradient-to-r from-festival-gold/10 to-festival-saffron/10 rounded-lg sm:rounded-xl border border-festival-orange/20">
                          ...
                          {day.specialNote && (
                            <div className="mobile-card bg-gradient-to-r from-pink-50 to-rose-50 rounded-lg sm:rounded-xl border-2 border-pink-200 text-center">
