...
import { MapPin, Search, ChevronDown, ChevronUp, Navigation, Users, Zap, Star, Grid3X3 } from "lucide-react";
...
export default function AreaGuide() {
  ...
  const filteredAreas = useMemo(() => {
    return areaData.filter(area => {
      const matchesSearch = area.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
                           area.pandals.some(p => p.name.toLowerCase().includes(searchTerm.toLowerCase()));
  ...
  const totalPandals = areaData.reduce((total, area) => total + area.pandals.length, 0);
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              { value: "3", label: "Zones", icon: <MapPin className="w-8 h-8" />, color: "from-blue-500 to-indigo-600" },
              { value: "Easy", label: "Search", icon: <Search className="w-8 h-8" />, color: "from-emerald-500 to-green-600" }
            ].map((stat, index) => (
              <motion.div
                key={index}
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {[
                    { icon: <Navigation className="w-5 h-5" />, title: "Choose Your Area", desc: "Select from 18+ areas across Kolkata", color: "from-festival-orange to-festival-saffron" },
                          ...
                          <CardHeader className="cursor-pointer hover:bg-gradient-to-r hover:from-festival-orange/5 hover:to-festival-saffron/5 transition-all duration-300 border-l-4 border-transparent hover:border-festival-orange">
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-6">
                                ...
                                <div>
                                  <CardTitle className="text-xl text-gray-800 mb-2">{area.name}</CardTitle>
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                <motion.div
                                  animate={{ rotate: openAreas.includes(area.name) ? 180 : 0 }}
                                  transition={{ duration: 0.3 }}
                                >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-600">
                Most visited areas during Durga Puja with the highest concentration of pandals
              </p>
            </motion.div>
              ...
              {areaData.slice(0, 6).map((area, index) => (
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <p className="text-festival-orange font-semibold text-lg mb-2">{area.pandals.length} Pandals</p>
                    <Badge className={getZoneColor(area.zone)}>
                      {area.zone} Kolkata
                    </Badge>
                  </div>
