...
import { Calendar, MapPin, BookOpen, Camera, Sparkles, Users, Clock, Star, Heart, Zap, Crown, Map } from "lucide-react";
  ...
  const featuredSections = [
    {
      ...
      description: "Discover the sacred rituals and age-old traditions that make Durga Puja so special",
      icon: <Sparkles className="w-8 h-8" />,
      link: "/rituals",
      color: "from-festival-orange to-festival-saffron",
      hoverColor: "from-festival-orange-dark to-festival-saffron-dark",
      image: "https://images.pexels.com/photos/16132278/pexels-photo-16132278.jpeg"
    },
    {
      title: "History & Origins",
      description: "Learn about the fascinating history and mythological origins of Durga Puja",
      icon: <BookOpen className="w-8 h-8" />,
      link: "/history",
      color: "from-festival-gold to-festival-amber",
      hoverColor: "from-festival-gold-dark to-yellow-500",
      image: "https://images.pexels.com/photos/25473186/pexels-photo-25473186.jpeg"
    },
    {
      title: "Photo Gallery",
      description: "Experience the visual splendor of Kolkata's most magnificent pandals",
      icon: <Camera className="w-8 h-8" />,
      link: "/gallery",
      color: "from-festival-maroon to-festival-crimson",
      hoverColor: "from-festival-maroon-light to-red-600",
      image: "https://images.pexels.com/photos/31739353/pexels-photo-31739353.jpeg"
    }
  ];
      ...
      >
        ...
        <div className="relative z-20 container mx-auto px-4 py-24 h-full flex items-center">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Explore the magnificent world of Durga Puja in Kolkata - from ancient traditions 
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {highlights.map((item, index) => (
              ...
              >
                <motion.div
                  className="absolute inset-0 bg-gradient-to-br from-festival-orange/10 to-festival-saffron/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                />
                <motion.div 
                ...
                <p className="text-gray-600 font-medium relative z-10">{item.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-2xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Dive deep into the various aspects of Durga Puja celebrations with our comprehensive sections
            </p>
          </motion.div>
      ...
      >
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            initial={{ y: 30, opacity: 0 }}
            animate={{ y: isGalleryInView ? 0 : 30, opacity: isGalleryInView ? 1 : 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
          >
            ...
            <p className="text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Experience the beauty and grandeur of Durga Puja through stunning visuals
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                image: "https://images.pexels.com/photos/7686385/pexels-photo-7686385.jpeg",
              ...
              <motion.div
                ...
                animate={{ opacity: isGalleryInView ? 1 : 0, y: isGalleryInView ? 0 : 30 }}
          ...
          >
            <Link to="/gallery">
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
              >
                <Button size="lg" className="bg-gradient-to-r from-festival-orange to-festival-saffron hover:from-festival-orange-dark hover:to-festival-saffron-dark text-xl px-10 py-6 shadow-festival-lg">
                  <Camera className="w-6 h-6 mr-3" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              animate={{ x: isAboutInView ? 0 : -50, opacity: isAboutInView ? 1 : 0 }}
              transition={{ duration: 0.8, delay: 0.2 }}
            >
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed text-lg">
                ...
                >
                  Durga Puja is the most significant festival in Bengal, celebrating the victory of 
                  Goddess Durga over the demon Mahishasura. This five-day festival transforms 
                  Kolkata into a vibrant canvas of art, culture, and devotion.
                </motion.p>
                <motion.p
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: isAboutInView ? 1 : 0, y: isAboutInView ? 0 : 20 }}
                ...
                >
                  From magnificent pandals showcasing artistic excellence to the rhythmic beats of 
                  dhak, from the aroma of bhog to the sound of conch shells - Durga Puja is a 
                  sensory experience that binds the community together.
                </motion.p>
                <motion.p
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: isAboutInView ? 1 : 0, y: isAboutInView ? 0 : 20 }}
                  transition={{ duration: 0.6, delay: 0.8 }}
                >
                  This blog is your comprehensive guide to understanding every aspect of this 
                  beautiful festival, curated from authentic sources and personal experiences.
                </motion.p>
              </div>
              <motion.div 
              ...
              >
                <Link to="/about">
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    <Button size="lg" className="bg-gradient-to-r from-festival-orange to-festival-saffron hover:from-festival-orange-dark hover:to-festival-saffron-dark text-xl px-8 py-6 shadow-festival-lg">
            ...
            >
              ...
              >
                ...
                <div className="text-center relative z-10">
                  ...
                  <h3 className="text-3xl font-bold mb-6 text-festival-gold">Sacred Mantras</h3>
      ...
      >
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Durga Puja is more than a religious festival - it's a celebration of art, culture, 
              and the triumph of good over evil that unites millions across Bengal and beyond.
            </p>
          </motion.div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            {[
              { title: "Art & Sculpture", desc: "Magnificent clay artistry", emoji: "🎨", color: "from-pink-500 to-rose-600" },
              { title: "Music & Dance", desc: "Cultural performances", emoji: "🎵", color: "from-purple-500 to-indigo-600" },
              { title: "Food & Feast", desc: "Traditional Bengali cuisine", emoji: "🍽️", color: "from-festival-orange to-festival-saffron" },
              { title: "Community Spirit", desc: "Unity and togetherness", emoji: "🤝", color: "from-emerald-500 to-green-600" }
            ].map((item, index) => (
              <motion.div 
                key={index}
                variants={itemVariants}
      ...
      >
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Experience the beauty, artistry, and cultural magnificence of Kolkata's Durga Puja celebrations
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <p className="text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Every journey through Durga Puja tells a unique story. Choose your adventure.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Explore century-old Bonedi Baris and their traditional celebrations",
                icon: "🏛️",
                color: "from-yellow-400 to-orange-500",
                bgImage: "https://images.pexels.com/photos/12173961/pexels-photo-12173961.jpeg"
              },
              {
                title: "Metro Guide",
                description: "Navigate easily with our comprehensive metro route planning",
                icon: "🚇",
                color: "from-blue-400 to-indigo-500",
                bgImage: "https://images.pexels.com/photos/5559377/pexels-photo-5559377.jpeg"
              },
              {
                title: "Personal Plan",
                description: "Follow my documented journey and discover hidden gems",
                icon: "📋",
                color: "from-green-400 to-emerald-500",
                bgImage: "https://images.pexels.com/photos/28832088/pexels-photo-28832088.jpeg"
              },
              {
                title: "Cultural Insights",
                description: "Learn the deep traditions and spiritual significance",
                icon: "📚",
                color: "from-purple-400 to-pink-500",
                bgImage: "https://images.pexels.com/photos/18362801/pexels-photo-18362801.jpeg"
              }
            ].map((item, index) => (
              <motion.div
                key={index}
              ...
              >
                ...
                <div className="relative p-8 text-center">
                  ...
                  <h3 className={`text-xl font-bold mb-3 bg-gradient-to-r ${item.color} bg-clip-text text-transparent`}>
                    {item.title}
                  </h3>
